...
import { setSelectedCurrency } from "../../../../Store/currenciesSlice";
      ...
      <div className={classes.CurrenciesDropMenu}>
        ...
        >
          ...
          <span className={classes.arrowIcon}>
            {this.state.showMenu ? <img src="/images/arrow_Up.png" alt="arrowUp"/> : <img src="/images/arrow_Down.png" alt="arrowDown"/>}
          </span>
        </div>
